...
const routes: Routes = [
  ...
  // routes following roles
  {path: 'admin', component:CategoriesComponent, canActivate : [AuthenticationGuard], children : [
  ...
  {path: 'rh', component:CategorieEditComponent, canActivate : [AuthenticationGuard], children : [
  ...
  {path: 'statistiques', component:StatistiquesComponent, canActivate : [AuthenticationGuard]},  
